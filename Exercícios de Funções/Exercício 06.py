...
# dois inteiros. Deve haver pelo menos duas funções: 
# uma para fazer a conversão# e uma para a saída.

# Registre a informação A.M./P.M. como um valor ‘A’ para 
# A.M. e ‘P’ para P.M. Assim, a função para efetuar as conversões terá um parâmetro
...
def saida(tipoAouP,hora,minuto):
  if(tipoAouP == 'A'):
    print('{}:{} {}.M.'.format(hora,minuto,tipoAouP))
  else:
    print('{}:{} {}.M.'.format(hora-12,minuto,tipoAouP))

tipoAouP = tipo(hora)
saida(tipoAouP,hora,minuto)
