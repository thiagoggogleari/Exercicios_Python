# 11 Jogo de Forca. Desenvolva um jogo da forca. O programa terá uma lista de palavras lidas de um arquivo texto e escolherá uma aleatoriamente. 
...
palavraDoSegredo = arquivoPokemon[x]
...
while True:
  ...
  if(''.join(lista) == palavraDoSegredo):
    ...
    letrasJaInseridas()
    print("Você acertou!!!!")
    print("O pokemon é : %s"%(palavraDoSegredo))
    print("*"*50)
    break
  else:
    print()
