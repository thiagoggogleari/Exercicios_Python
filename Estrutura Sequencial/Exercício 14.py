...
# maior que o estabelecido pelo regulamento de pesca do estado de São Paulo (50 quilos) deve pagar uma multa de R$ 4,00 por quilo excedente. João precisa que 
...
if(peso > 50):
    multa = (peso - 50) * 4
    excesso = (peso - 50)
    print('Você irá pagar R$%.2f de multa pelo excedente de %.2fkg'%(multa,excesso))
else:
    print('Você não ultrapassou a cota de 50kg')
